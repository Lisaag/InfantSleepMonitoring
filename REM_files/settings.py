...
#val_ids = ['416', '773'] #REM god, OREM heel slecht
#val_ids = ['416', '440'] #REM god, OREM heel slecht
#val_ids = ['004', '773', '875'] #REM acceptabel/goed, OREM acceptabel/goed
val_ids = ['399', '440', '866'] #REM goed , OREM goed
