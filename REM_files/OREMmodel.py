...
def REMtrain():
    ...
    checkpoint = keras.callbacks.ModelCheckpoint(filepath = os.path.join(os.path.abspath(os.getcwd()),"REM-results","checkpoint.model.keras"), monitor='val_loss', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', save_freq=1)
