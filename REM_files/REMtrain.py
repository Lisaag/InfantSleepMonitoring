...
def lr_schedule(epoch):
    ...
    return initial_lr * (0.85 ** (epoch // 5))  # Reduce LR every 5 epochs
...
def REMtrain(val_ids, idx, dir, batch_size, lr, l2, dropout, seed):
    ...
    history = model.fit(train_samples_stacked, train_labels_bce, validation_data=(val_samples_stacked, val_labels_bce), epochs=60, batch_size=batch_size, callbacks=[lr_callback, checkpoint, es_callback])
