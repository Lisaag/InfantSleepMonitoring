...
def REMtrain(val_ids, idx, dir, batch_size, lr, l2, dropout):
    ...
    history = model.fit(train_samples_stacked, train_labels_bce, validation_data=(val_samples_stacked, val_labels_bce), epochs=100, batch_size=batch_size, callbacks=[es_callback, checkpoint])
